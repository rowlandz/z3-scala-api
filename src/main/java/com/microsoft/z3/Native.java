...
public final class Native {
  ...
  protected static native void INTERNALsolverNextSplit(long a0, long a1, long a2, int a3, int a4);
  ...
  protected static native void INTERNALsolverPropagateConsequence(long a0, long a1, int a2, long[] a3, int a4, long[] a5, long[] a6, long a7);
  ...
  public static void solverNextSplit(long a0, long a1, long a2, int a3, int a4) throws Z3Exception
  {
      INTERNALsolverNextSplit(a0, a1, a2, a3, a4);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
  }
  ...
  public static void solverPropagateConsequence(long a0, long a1, int a2, long[] a3, int a4, long[] a5, long[] a6, long a7) throws Z3Exception
  {
      INTERNALsolverPropagateConsequence(a0, a1, a2, a3, a4, a5, a6, a7);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
  }
